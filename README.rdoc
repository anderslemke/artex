...
{<img src="https://travis-ci.org/korobkov/artex.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/korobkov/artex]
...
Source repository at: http://gitlab.com/korobkov/artex

== Dependencies

* pdflatex executable, available in modern TeXLive distributions
* Requires Ruby
